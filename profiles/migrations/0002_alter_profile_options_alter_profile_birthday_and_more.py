...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='userdocument',
            name='image',
            field=models.ImageField(blank=True, upload_to='', verbose_name='تصویر مدرک'),
        ),
        migrations.AlterField(
            model_name='userdocument',
            name='title',
            field=models.CharField(blank=True, choices=[('شناسنامه', 'شناسنامه'), ('کارت ملی', 'کارت ملی'), ('پاسپورت', 'پاسپورت'), ('سایر', 'سایر')], max_length=125, verbose_name='عنوان'),
        ),
        migrations.AlterField(
            model_name='userdocument',
            name='user',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='docs', to=settings.AUTH_USER_MODEL, verbose_name=''),
        ),
    ]
