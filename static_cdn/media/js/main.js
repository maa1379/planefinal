...
if (check1.checked === true) {
    document.getElementById('goDate').style.display = "block";
    document.getElementById('goDateSpan').style.display = "block";
    document.getElementById('returnDate').style.display = "none";
    document.getElementById('returnDateSpan').style.display = "none";
}
...
function toggletypeTravel(type) {
    ...
    if (type === 2) {
        document.getElementById('goDate').style.display = "block";
        document.getElementById('returnDateSpan').style.display = "block";
...
let travelClicks = document.getElementById('travelNav');
let travelIds = document.getElementById('travelMenu');

travelClicks.addEventListener('click', function (e) {
    travelIds.click()
    e.preventDefault()
    window.scrollBy(0, 400)
})
